					...
					<table>
						...
						<tr>
		                    ...
		                    <td><input type="number" name="qty" id="qty" value="12" min="12" max="<?php echo $b['barang_stok'];?>" class="form-control input-sm" style="width:90px;margin-right:5px;" required></td>
