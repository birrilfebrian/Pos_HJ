                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Suplier (Opsional)</label>
                            <div class="col-xs-9">
                                <select name="suplier" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Kategori" data-width="80%" placeholder="Pilih Kategori">
                                <?php foreach ($sup->result_array() as $sp) {
                                    $id_sp=$sp['suplier_id'];
                                    $sp_nm=$sp['suplier_nama'];
                                    ?>
                                        <option value="<?php echo $id_sp;?>"><?php echo $sp_nm;?></option>
                                <?php }?>
