                  ...
                  <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                    <thead>
                        <tr>
                            ...
                            <th style="width:120px;">Nama Suplier</th>
                            <th>Satuan</th>
                    ...
                    <?php 
                        ...
                        foreach ($data->result_array() as $a):
                            ...
                            $b = $this->db->query("SELECT tbl_suplier.suplier_nama FROM tbl_barang RIGHT JOIN tbl_suplier ON tbl_barang.suplier_id=tbl_suplier.suplier_id where tbl_suplier.suplier_id='".$a['suplier_id']."'")->row_array();
                            $nama_suplier=$b['suplier_nama'];
                    ?>
                        <tr>
                            ...
                            <input type="hidden"  value="<?php echo $nama_suplier;?>">
