   ...
   ?>
    ...
    <div class="container">
            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Pembelian Barang</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/lap_pembelian_barang'?>" target="_blank"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Laba/Rugi Bulanan</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_laba_rugi_bulanan" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align:center;vertical-align:middle">9</td>
                        <td style="vertical-align:middle;">Laporan Laba/Rugi Tahunan</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_laba_rugi_tahunan" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_laba_rugi_harian" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
        ...
        <div class="modal fade" id="lap_jual_pertahun" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
         ...
         <!-- ============ MODAL ADD =============== -->
         <div class="modal fade" id="lap_laba_rugi_harian" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel">Pilih Hari</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/lap_laba_rugi_harian'?>" target="_blank">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >Hari</label>
                        <div class="col-xs-9">
                                <select name="hari" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Hari" data-width="80%" required/>
                                <?php foreach ($jual_hari->result_array() as $k) {
                                    $bln=$k['hari'];
                                ?>
                                    <option><?php echo $bln;?></option>
                                <?php }?>
         ...
         <!-- ============ MODAL ADD =============== -->
         <div class="modal fade" id="lap_laba_rugi_tahunan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/lap_laba_rugi_tahunan'?>" target="_blank">
                <div class="modal-body">
         ...
         <!-- ============ MODAL ADD =============== -->
        <div class="modal fade" id="lap_laba_rugi_bulanan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
